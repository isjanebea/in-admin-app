...
import { ACTION_NAVIGATE_SYNC, NavigateSyncResponse } from '@tiendanube/nexo/actions';
...
function NexoSyncRoute({ children }: { children: JSX.Element }) {
    ...
    useEffect(() => {
        const unsuscribe = nexo.suscribe(ACTION_NAVIGATE_SYNC, ({ path, replace }: NavigateSyncResponse) => {
